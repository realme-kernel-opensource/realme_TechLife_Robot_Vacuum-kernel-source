/*
 * linux-4.9/drivers/media/platform/sunxi-vfe/platform/sun8iw8p1_vfe_cfg.h
 *
...
#define ISP_STAT_AE_MEM_OFS         (ISP_STAT_HIST_MEM_OFS \
					+ ISP_STAT_HIST_MEM_SIZE)
#define ISP_STAT_AWB_MEM_OFS        (ISP_STAT_AE_MEM_OFS \
					+ ISP_STAT_AE_MEM_SIZE)
#define ISP_STAT_AF_MEM_OFS         (ISP_STAT_AWB_MEM_OFS \
					+ ISP_STAT_AWB_MEM_SIZE)
#define ISP_STAT_AFS_MEM_OFS        (ISP_STAT_AF_MEM_OFS \
					+ ISP_STAT_AF_MEM_SIZE)
#define ISP_STAT_AWB_WIN_MEM_OFS    (ISP_STAT_AFS_MEM_OFS \
