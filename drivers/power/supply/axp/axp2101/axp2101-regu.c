...
static struct axp_regulator_info axp2101_regulator_info[] = {
	...
	AXP2101_LDO(2, 3000, 3000, 1, LDO2, 0, 0, LDO2EN, 0x01, 0x01, 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(3, 500, 3500, 100, LDO3, 0, 5, LDO3EN, BIT(0), BIT(0), 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(4, 500, 3500, 100, LDO4, 0, 5, LDO4EN, BIT(1), BIT(1), 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(5, 500, 3500, 100, LDO5, 0, 5, LDO5EN, BIT(2), BIT(2), 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(6, 500, 3500, 100, LDO6, 0, 5, LDO6EN, BIT(3), BIT(3), 0x00,
		    3400, 200, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(7, 500, 3500, 100, LDO7, 0, 5, LDO7EN, BIT(4), BIT(4), 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(8, 500, 3500, 100, LDO8, 0, 5, LDO8EN, BIT(5), BIT(5), 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(9, 500, 1400, 50, LDO9, 0, 5, LDO9EN, BIT(6), BIT(6), 0x00, 0,
		    1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(10, 500, 3500, 100, LDO10, 0, 5, LDO10EN, BIT(7), BIT(7), 0x00,
		    0, 1, 0, 0, 0, 0, 0, 0),
	AXP2101_LDO(11, 500, 1400, 50, LDO11, 0, 5, LDO11EN, BIT(0), BIT(0), 0x00,
		    0, 1, 0, 0, 0, 0, 0, 0),
