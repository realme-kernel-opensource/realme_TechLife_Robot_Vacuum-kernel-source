...
static irqreturn_t gpio_hostwakeup_irq_thread(int irq, void *data)
{
    ...
    static bool wlan_first_wakeup = true;
    int wifi_suspend_flag = 0;
    if( wlan_first_wakeup ){
            wlan_first_wakeup = false;
    }else{
            wifi_suspend_flag = sunxi_wlan_set_suspend_flag(1);
    }
...
static int __init rtw_drv_entry(void)
{
    ...
    RTW_INFO("%s: add by hfh 2020-09-18\n", __FUNCTION__);
