...
static const struct snd_soc_dai_driver ac102_dai0 = {
	.name = "ac102-pcm0",
	.playback = {
...
static const struct snd_soc_dai_driver ac102_dai1 = {
	.name = "ac102-pcm1",
	.playback = {
		.stream_name = "Playback",
		.channels_min = 1,
...
static const struct snd_soc_dai_driver ac102_dai2 = {
	.name = "ac102-pcm2",
	.playback = {
		.stream_name = "Playback",
		.channels_min = 1,
...
static const struct snd_soc_dai_driver ac102_dai3 = {
	.name = "ac102-pcm3",
	.playback = {
		.stream_name = "Playback",
		.channels_min = 1,
...
static const struct snd_soc_dai_driver *ac102_dai[] = {
